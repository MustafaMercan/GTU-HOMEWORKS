...
public class Account{
     ...
     */
    public int find_index_account( LDLinkedList<Account> user_accounts,String user_name)
    {
        int index = 0;
     ...
     */ 
    public void view_profile(LDLinkedList<Account> user_accounts, String user_name)
    {
     ...
     * @param user_name it holds the username of the user whose profile we want to view.
     */  
    public void view_user_posts(LDLinkedList<Account> user_accounts, String user_name)
    {
     ...
     */ 
    public void follow_someone(LDLinkedList<Account> user_accounts,String user_name)
    {
    ...
    public void unfollow_someone(LDLinkedList<Account> user_accounts,String user_name)
    {
        if(this.check_login_state())
        {
            int user_index = this.find_index_account(user_accounts,user_name);
    ...
    public void unfollow_someone(LDLinkedList<Account> user_accounts,String user_name, boolean flag)
    {
     ...
     */ 
    public void unlike_a_post(LDLinkedList<Account> user_accounts,String user_name, int post_id)
    {
        if(this.check_login_state())
        {
            int user_index = this.find_index_account(user_accounts,user_name);
    ...
    public void like_a_post(LDLinkedList<Account> user_accounts,String user_name, int post_id)
    {
        if(this.check_login_state())
        {
            int user_index = this.find_index_account(user_accounts,user_name);
     ...
     */ 
    public void add_comment_post(LDLinkedList<Account> user_accounts,long post_id,String content)
    {
        int user_index = 0;
        int post_index = 0;
     ...
     */
    public void get_all_interactions(LDLinkedList<Account> user_accounts, String user_name)
    {
        if(this.check_login_state())
        {
            int user_index = this.find_index_account(user_accounts,user_name);
    ...
    public void uncomment_post(LDLinkedList<Account> user_accounts, String user_name,long post_id)
    {
        if(this.check_login_state())
        {
            int user_index = this.find_index_account(user_accounts,user_name);
     ...
     */
    public void send_message(LDLinkedList<Account> user_accounts, String user_name, long message_id, String message_content)
    {
    ...
    public void block_someone(LDLinkedList<Account> user_accounts, String user_name)
    {
        int user_index = this.find_index_account(user_accounts,user_name);
        int index = 0;
        if(user_index == -1)
    ...
    */
     ...
     * @param user_name is the username of the user to be blocked
     */
    public void unblock_someone(LDLinkedList<Account> user_accounts, String user_name)
    {
        int user_index = this.find_index_account(user_accounts,user_name);
        int index = 0;
        if(user_index == -1)
